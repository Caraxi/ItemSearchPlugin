    ...
    internal class ItemSearchWindow : IDisposable {
        ...
        public ItemSearchWindow(ItemSearchPlugin plugin, string searchText = "") {
            ...
            SearchFilters = new List<SearchFilter> {
                ...
                new BooleanSearchFilter(pluginConfig, "Multi-slot", "Multi-slot", "Single-slot", (i, t, f) => (i.EquipSlotCategory.RowId >= 15 && i.EquipSlotCategory.RowId <= 23 && i.EquipSlotCategory.RowId != 17) ? t : f),
